...
export const getByPath = (target, segments) => {
  ...
  return getByPath(target?.[segment], remaining)
}
...
export const setByPath = (target, segments, value) => {
  ...
  target[segment] = setByPath(target?.[segment], remaining, value)
  return target
}
...
console.log(getByPath(obj, '/a/1/c/0'))
setByPath(obj, '/a/1/c/~/a', 456)
console.log(obj)
